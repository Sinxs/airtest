...
def Main(devices):
    class TCmainectype_chapter_five(unittest.TestCase):
        u'''测试用例TCmainectype_chapter_five的集合'''
        ...
        def test_Chapter_Five(self):
            ...
            """
            try:
                self.assertEqual("Duck", main_ectype.test_Chapter_Five(devices))
            except:
    ...
    srcSuite = unittest.makeSuite(TCmainectype_chapter_five)
    return srcSuite
