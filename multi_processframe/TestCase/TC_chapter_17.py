...
def Main(devices):
    class TC_chapter_17(unittest.TestCase):
        ...
        def test_Chapter_17(self):
            """
            主线关卡第十七章战斗流程测试--测试自动通关副本，检测地图卡点，对于没有自动战斗的关卡进入副本后退出
            """
            try:
                self.assertEqual("Duck", main_ectype.chapter_seventeen(devices))
    ...
    srcSuite = unittest.makeSuite(TC_chapter_17)
    return srcSuite
