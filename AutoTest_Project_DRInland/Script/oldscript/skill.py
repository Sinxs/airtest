...
def Switchroles_1(poco, devices):
    """
    1、重置脚本运行环境
    2、点击头像进入角色选择界面
    :return:
...
def Skill_Switchroles(damo,poco, devices):  # 重置当前职业
    poco=poco
    Switchroles_1(poco, devices)  # 点击切换角色，并重置测试环境
...
def test_warrior_1(start, devices):  # Prof1-转职为战士分支、剑圣分支、月之领主职业
    """
    转职为战士分支、剑圣分支、月之领主职业
    :return:
    """
    ...
    Prof1_zhiye(start, poco,devices)  # 转职为战士分支、剑圣分支、月之领主职业
    """点击月之领主职业"""
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块


def test_warrior_2(start, devices):  #  Prof1-转职为战士分支、剑圣分支、剑皇职业
    """
     转职为战士分支、剑圣分支、剑皇职业
    :return:
    """
    ...
    Prof1_zhiye(start, poco,devices)  # 转职为战士分支、剑圣分支、剑皇职业
    """点击月之领主职业"""
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块
...
def test_warrior_4(start, devices):  # Prof1- 转职为战士分支、战皇分支、狂战士者职业
    """
    ...
    """点击狂战士职业"""
    Prof1_zhiye(start, poco,devices)  # Prof1- 转职为战士分支、战皇分支、狂战士者职业
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块
...
def test_Archer_1(start, devices):  # Prof2-转职为弓箭手分支、箭神分支、魔羽分支
    """
    ...
    Prof1_zhiye(start, poco,devices)  # 转职为弓箭手分支、箭神分支
    poco("SkillTree(Clone)").offspring("Tabs").child("item2").click()  # 点击二转职业
    poco("ProDetail1").click()  # 转职为弓箭手分支、箭神分支、魔羽分支
    """点击魔羽职业"""
    Prof1_zhiye(start, poco,devices)  # Prof1- 转职为弓箭手分支、箭神分支、魔羽分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块


def test_Archer_2(start, devices):  # Prof2-转职为弓箭手分支、箭神分支、狙翎分支
    """
       Prof2-转职为弓箭手分支、箭神分支、魔羽分支
    :return:
    """
    ...
    """点击魔羽职业"""
    Prof1_zhiye(start, poco,devices)  # Prof1- 转职为弓箭手分支、箭神分支、狙翎分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块


def test_Archer_3(start, devices):  # Prof2-转职为弓箭手分支、猎人分支、银色猎人分支
    """
    ...
    Prof1_zhiye(start, poco,devices)  # 转职为弓箭手分支、猎人分支
    poco("SkillTree(Clone)").offspring("Tabs").child("item2").click()  # 点击二转职业
    poco("ProDetail1").click()  # 转职为弓箭手分支、猎人分支、银色猎人分支
    """点击银色猎人职业"""
    Prof1_zhiye(start, poco,devices)  # Prof1- 转职为弓箭手分支、猎人分支、银色猎人分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块
...
def test_magic_1(start, devices):  # Prof3-转职为魔法师分支、元素分支、冰灵分支
    """
    ...
    Prof1_zhiye(start, poco,devices)  # 转职为魔法师分支、元素分支
    poco("SkillTree(Clone)").offspring("Tabs").child("item2").click()  # 点击二转职业
    poco("ProDetail1").click()  # Prof3-转职为魔法师分支、元素分支、冰灵分支
    """点击冰灵分支职业"""
    Prof1_zhiye(start, poco,devices)  # Prof3-转职为魔法师分支、元素分支、冰灵分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块


def test_magic_2(start, devices):  # Prof3-转职为魔法师分支、元素分支、火舞分支
    """
    ...
    """点击火舞分支职业"""
    Prof1_zhiye(start, poco,devices)  #  Prof3-转职为魔法师分支、元素分支、火舞分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块


def test_magic_3(start, devices):  # Prof3-转职为魔法师分支、魔导师分支、黑暗女王分支
    """
    ...
    """点击黑暗女王分职业"""
    Prof1_zhiye(start, poco,devices)  #  Prof3-转职为魔法师分支、魔导师分支、黑暗女王分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块
...
def test_pastor_1(start, devices):  # Prof4-转职为牧师分支、祭祀分支、雷神分支
    """
    ...
    """点击雷神分支职业"""
    Prof1_zhiye(start, poco,devices)  # Prof4-转职为牧师分支、祭祀分支、雷神分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块


def test_pastor_2(start, devices):  # Prof4-转职为牧师分支、祭祀分支、圣徒分支
    """
    ...
    """点击圣徒分支职业"""
    Prof1_zhiye(start, poco,devices)  # Prof4-转职为牧师分支、祭祀分支、圣徒分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块
...
def test_pastor_4(start, devices):  # Prof4-转职为牧师分支、贤者分支、圣骑士分支
    """
    ...
    """点击圣骑士分支职业"""
    Prof1_zhiye(start, poco,devices)  # Prof4-转职为牧师分支、贤者分支、圣骑士分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块
...
def test_scholar_1(start, devices):  # Prof5-转职为学者分支、工程师分支、重炮手分支
    """
    ...
    Prof1_zhiye(start, poco,devices)  # Prof5-转职为学者分支、工程师分支
    poco("SkillTree(Clone)").offspring("Tabs").child("item2").click()  # 点击二转职业
    poco("ProDetail1").click()  # Prof5-转职为学者分支、工程师分支、重炮手分支
    """点击重炮手职业"""
    Prof1_zhiye(start, poco,devices)  # Prof5-转职为学者分支、工程师分支、重炮手分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块


def test_scholar_2(start, devices):  # Prof5-转职为学者分支、工程师分支、机械大师分支
    """
    ...
    """点击机械大师职业"""
    Prof1_zhiye(start, poco,devices)  # Prof5-转职为学者分支、工程师分支、机械大师分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块


def test_scholar_3(start, devices):  # Prof5-转职为学者分支、炼金术士分支、炼金圣士分支
    """
    ...
    """点击炼金圣士职业"""
    Prof1_zhiye(start, poco,devices)  # Prof5-转职为学者分支、炼金术士分支、炼金圣士分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块
...
def test_scholar_4(start, devices):  # Prof5-转职为学者分支、炼金术士分支、药剂师分支
    """
    ...
    """点击药剂师分支职业"""
    Prof1_zhiye(start, poco,devices)  #  Prof5-转职为学者分支、炼金术士分支、药剂师分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块
...
def test_thug_1(start, devices):  # Prof6-转职为刺客分支、暗之使徒分支、烈分支
    """
    ...
    Prof1_zhiye(start, poco,devices)  # Prof6-转职为刺客分支、暗之使徒分支
    poco("SkillTree(Clone)").offspring("Tabs").child("item2").click()  # 点击二转职业
    poco("ProDetail1").click()  # Prof6-转职为刺客分支、暗之使徒分支、烈分支
    """点击烈职业"""
    Prof1_zhiye(start, poco,devices)  #  PProf6-转职为刺客分支、暗之使徒分支、烈分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块
...
def test_thug_2(start, devices):  # Prof6-转职为刺客分支、暗之使徒分支、影分支
    """
    ...
    """点击影职业"""
    Prof1_zhiye(start, poco,devices)  # Prof6-转职为刺客分支、暗之使徒分支、影分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块
...
def test_thug_3(start, devices):  # Prof6-转职为刺客分支、光明之怒分支、耀分支
    """
    ...
    """点击耀职业"""
    Prof1_zhiye(start, poco,devices)  # Prof6-转职为刺客分支、光明之怒分支、耀分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块
...
def test_dance_1(start, devices):  # Prof7-转职为舞娘分支、呐喊者分支、噬魂者分支
    """
         Prof7-转职为舞娘分支、呐喊者分支、噬魂者分支
    :return:
    """
    poco = common.deviceconnect(devices)
    Skill_Switchroles(7,poco, devices)
    poco("SkillTree(Clone)").offspring("Tabs").child("item1").click()  # 点击15级转职
    poco("ProDetail1").click()  # PProf7-转职为舞娘分支、呐喊者分支
    Prof1_zhiye(start, poco,devices)  # Prof7-转职为舞娘分支、呐喊者分支
    poco("SkillTree(Clone)").offspring("Tabs").child("item2").click()  # 点击二转职业
    poco("ProDetail1").click()  # Prof7-转职为舞娘分支、呐喊者分支、噬魂者分支
    """点击噬魂者职业"""
    Prof1_zhiye(start, poco,devices)  # Prof7-转职为舞娘分支、呐喊者分支、噬魂者分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块
...
def test_dance_2(start, devices):  # Prof7-转职为舞娘分支、呐喊者分支、黑暗萨满分支
    """
    ...
    """点击黑暗萨满职业"""
    Prof1_zhiye(start, poco,devices)  # Prof7-转职为舞娘分支、呐喊者分支、黑暗萨满分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块



def test_dance_3(start, devices):  # Prof7-转职为舞娘分支、舞者分支、灵魂舞者分支
    """
    ...
    Prof1_zhiye(start, poco,devices)  # Prof7-转职为舞娘分支、舞者分支
    poco("SkillTree(Clone)").offspring("Tabs").child("item2").click()  # 点击二转职业
    poco("ProDetail1").click()  # Prof7-转职为舞娘分支、舞者分支、灵魂舞者分支
    """点击灵魂舞者职业"""
    Prof1_zhiye(start, poco,devices)  # Prof7-转职为舞娘分支、舞者分支、灵魂舞者分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块
...
def test_dance_4(start, devices):  # Prof7-转职为舞娘分支、舞者分支、刀锋舞者分支
    """
    ...
    """点击刀锋舞者职业"""
    Prof1_zhiye(start, poco,devices)  # Prof7-转职为舞娘分支、舞者分支、刀锋舞者分支
    juexing(poco)  # 点击觉醒
    return Skill(start, poco,devices)  # 测试技能模块
